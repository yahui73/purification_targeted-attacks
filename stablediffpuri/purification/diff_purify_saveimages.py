...
def diff_purify(x, diffusion, max_iter, mode, config):
    ...
    with torch.no_grad():
        ...
        for i in range(max_iter):
            ...
            #save_images[
            save_images(diffusion.diffuse_t_steps(xt_reverse, 400),'./saveimages/Diff-purify/generate_cifar10/diffuse400')
            save_images(diffusion.diffuse_t_steps(xt_reverse, 200),'./saveimages/Diff-purify/generate_cifar10/diffuse200')
            save_images(diffusion.diffuse_t_steps(xt_reverse, 100),'./saveimages/Diff-purify/generate_cifar10/diffuse100')
            save_images(diffusion.diffuse_t_steps(xt_reverse, 0),'./saveimages/Diff-purify/generate_cifar10/diffuse0')
            #]
            ...
            save_images(x200,'./saveimages/Diff-purify/generate_cifar10/reverse200')
            save_images(x100,'./saveimages/Diff-purify/generate_cifar10/reverse100')
            save_images(x000,'./saveimages/Diff-purify/generate_cifar10/reverse0')
            save_images(xt_reverse,'./saveimages/Diff-purify/generate_cifar10/reverse')
            #]
